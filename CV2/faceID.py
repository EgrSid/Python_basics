...
face_cascade = cv.CascadeClassifier(
    'C:\ML\opencv-4.x\data\haarcascades\haarcascade_frontalface_default.xml')

capture = cv.VideoCapture(fr"video\my_test_vid.mp4")
capture.set(cv.CAP_PROP_FPS, 20)

model = tf.keras.models.load_model(fr"C:\ML\IMPORTANT_PROGGRAMES\TF\face_recogn_model_prep_681.h5")
